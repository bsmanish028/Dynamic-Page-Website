...
<html>
<head>
    <title>Website with Dynamic Pages</title>
...
<body>
    ...
    <section class="links">
	   ...
	   <br>
        ...
        <!-- Footer Area -->
        <div id="footer"><hr><p>Developed by | Manish Kumar |&copy;2018 All right reserved.
	<br>
	<br>This Website is made by using HTML, CSS, JavaScript and two Super Global variable &nbsp;(GET and POST) of PHP.
	</p><hr>
